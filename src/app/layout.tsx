...
import { LayoutDashboard, Users, Settings, MapPin, Hash, BarChart2 } from "lucide-react";
        ...
        <div className="flex h-screen bg-gray-100">
          ...
          <aside className="w-64 bg-white border-r shadow-sm">
            ...
            <nav className="p-4 space-y-2">
              ...
              <Link href="/data-quality" className="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-lg">
